...
public abstract class Monster implements Comparable<Monster> {
	...
	public void alterEnergy(int energy) {
		if(this.isShielded() && energy <0 ) { // Case 1: shield blocks negative energy
			this.setShielded(false); // consume shield
			return; // DO NOT change energy
		}
		this.setEnergy(this.getEnergy() + energy); // Case 2 & 3: apply energy normally
